...
export function saveMerchantSecret(taxMerchantSecretVO?: TaxMerchantSecretVO, success?: (data: WebResult<string>["data"], response: WebResult<string>, xhr: any) => void, error?: (message: WebResult<string>["message"], response: WebResult<string>, xhr: any) => void, options?: any): Promise<WebResult<string>["data"]> {
    return ajax({
        url: `/supervisor/merchantsecret/saveMerchantSecret`,
        data: {
 ...
 * @param error 请求失败的回调函数
 */
export function queryPlatformSecret(merchantNo?: string, success?: (data: WebResult<TaxPlatformSecretVO>["data"], response: WebResult<TaxPlatformSecretVO>, xhr: any) => void, error?: (message: WebResult<TaxPlatformSecretVO>["message"], response: WebResult<TaxPlatformSecretVO>, xhr: any) => void, options?: any): Promise<WebResult<TaxPlatformSecretVO>["data"]> {
    return ajax({
