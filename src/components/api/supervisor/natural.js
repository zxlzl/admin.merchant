...
function queryNaturalPersonDetail(id, success, error, options) {
    return request_1.ajax(__assign({ url: "/supervisor/natural/queryNaturalPersonDetail", type: "POST", data: {
            id: id
...
function queryNaturalPersonList(query, success, error, options) {
    return request_1.ajax(__assign({ url: "/supervisor/natural/queryNaturalPersonList", type: "POST", contentType: "application/json", data: {
            query: query
        }, success: success, error: error }, options));
}
