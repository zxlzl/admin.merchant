 ...
 * @param error 请求失败的回调函数
 */
export function queryPrepaidByMerchantNo(merchantNo?: string, success?: (data: WebResult<TaxMerchantInvoicingInfoDTO>["data"], response: WebResult<TaxMerchantInvoicingInfoDTO>, xhr: any) => void, error?: (message: WebResult<TaxMerchantInvoicingInfoDTO>["message"], response: WebResult<TaxMerchantInvoicingInfoDTO>, xhr: any) => void, options?: any): Promise<WebResult<TaxMerchantInvoicingInfoDTO>["data"]> {
    return ajax({
        url: `/supervisor/merchantInvoicingInfo/queryPrepaidByMerchantNo`,
        type: "POST",
        data: {
 ...
 * @param error 请求失败的回调函数
 */
export function updateInvoicingInfo(billingInfoDTO?: TaxMerchantInvoicingInfoDTO, success?: (data: WebResult<boolean>["data"], response: WebResult<boolean>, xhr: any) => void, error?: (message: WebResult<boolean>["message"], response: WebResult<boolean>, xhr: any) => void, options?: any): Promise<WebResult<boolean>["data"]> {
    return ajax({
        url: `/supervisor/merchantInvoicingInfo/updateInvoicingInfo`,
        type: "POST",
        data: {
            billingInfoDTO: billingInfoDTO
        },
 ...
 * @param error 请求失败的回调函数
 */
export function queryByMerchantNo(merchantNo?: string, success?: (data: WebResult<TaxMerchantInvoicingInfoDTO>["data"], response: WebResult<TaxMerchantInvoicingInfoDTO>, xhr: any) => void, error?: (message: WebResult<TaxMerchantInvoicingInfoDTO>["message"], response: WebResult<TaxMerchantInvoicingInfoDTO>, xhr: any) => void, options?: any): Promise<WebResult<TaxMerchantInvoicingInfoDTO>["data"]> {
    return ajax({
        url: `/supervisor/merchantInvoicingInfo/queryByMerchantNo`,
        type: "POST",
        data: {
            merchantNo: merchantNo
        },
...
export function queryPrepaidInvoicingInfo(success?: (data: WebResult<TaxMerchantInvoicingInfoDTO>["data"], response: WebResult<TaxMerchantInvoicingInfoDTO>, xhr: any) => void, error?: (message: WebResult<TaxMerchantInvoicingInfoDTO>["message"], response: WebResult<TaxMerchantInvoicingInfoDTO>, xhr: any) => void, options?: any): Promise<WebResult<TaxMerchantInvoicingInfoDTO>["data"]> {
    return ajax({
        url: `/supervisor/merchantInvoicingInfo/queryPrepaidInvoicingInfo`,
        type: "POST",
        success: success,
        error: error,
        ...options
