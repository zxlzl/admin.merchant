...
function queryPayOrderPage(vo, success, error, options) {
    return request_1.ajax(__assign({ url: "/remit/payorder/queryPayOrderPage", contentType: "application/json", data: {
            vo: vo
...
function queryOrder(id, success, error, options) {
    return request_1.ajax(__assign({ url: "/remit/payorder/queryOrder", data: {
            id: id
        }, success: success, error: error }, options));
}
