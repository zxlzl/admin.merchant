 ...
 */
export function addAuthentication(authenticationInfoDto?: AuthenticationInfoDto, success?: (data: WebResult["data"], response: WebResult, xhr: any) => void, error?: (message: WebResult["message"], response: WebResult, xhr: any) => void, options?: any): Promise<WebResult["data"]> {
    return ajax({
        url: `/remit/authentication/addAuthentication`,
        type: "POST",
        data: {
...
export function queryAuthenticationDetail(id?: number, success?: (data: WebResult_1<TaxAuthenticationInfoDTO>["data"], response: WebResult_1<TaxAuthenticationInfoDTO>, xhr: any) => void, error?: (message: WebResult_1<TaxAuthenticationInfoDTO>["message"], response: WebResult_1<TaxAuthenticationInfoDTO>, xhr: any) => void, options?: any): Promise<WebResult_1<TaxAuthenticationInfoDTO>["data"]> {
    return ajax({
        url: `/remit/authentication/queryAuthenticationDetail`,
        type: "POST",
        data: {
            id: id
        },
 ...
 * @param error 请求失败的回调函数
 */
export function updateAuthentication(authenticationInfoDto?: AuthenticationInfoDto, success?: (data: WebResult["data"], response: WebResult, xhr: any) => void, error?: (message: WebResult["message"], response: WebResult, xhr: any) => void, options?: any): Promise<WebResult["data"]> {
    return ajax({
        url: `/remit/authentication/updateAuthentication`,
        type: "POST",
        data: {
            authenticationInfoDto: authenticationInfoDto
        },
 ...
 * @param error 请求失败的回调函数
 */
export function cancelAuthentication(id?: number, success?: (data: WebResult["data"], response: WebResult, xhr: any) => void, error?: (message: WebResult["message"], response: WebResult, xhr: any) => void, options?: any): Promise<WebResult["data"]> {
    return ajax({
        url: `/remit/authentication/cancelAuthentication`,
        type: "POST",
        data: {
            id: id
        },
...
export function queryAuthenticationList(query?: TaxAuthenticationInfoVO, success?: (data: WebResult_1<PageBean_1<TaxAuthenticationInfoDTO>>["data"], response: WebResult_1<PageBean_1<TaxAuthenticationInfoDTO>>, xhr: any) => void, error?: (message: WebResult_1<PageBean_1<TaxAuthenticationInfoDTO>>["message"], response: WebResult_1<PageBean_1<TaxAuthenticationInfoDTO>>, xhr: any) => void, options?: any): Promise<WebResult_1<PageBean_1<TaxAuthenticationInfoDTO>>["data"]> {
    return ajax({
        url: `/remit/authentication/queryAuthenticationList`,
        type: "POST",
