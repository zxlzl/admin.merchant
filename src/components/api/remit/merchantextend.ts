 ...
 */
export function updateInviteCode(inviteCode?: string, success?: (data: WebResult<TaxMerchantExtendDTO>["data"], response: WebResult<TaxMerchantExtendDTO>, xhr: any) => void, error?: (message: WebResult<TaxMerchantExtendDTO>["message"], response: WebResult<TaxMerchantExtendDTO>, xhr: any) => void, options?: any): Promise<WebResult<TaxMerchantExtendDTO>["data"]> {
    return ajax({
        url: `/remit/merchantextend/updateInviteCode`,
        data: {
...
export function queryByMerchantNo(merchantNo?: string, success?: (data: ServiceResult<TaxMerchantExtendDTO>["data"], response: ServiceResult<TaxMerchantExtendDTO>, xhr: any) => void, error?: (message: ServiceResult<TaxMerchantExtendDTO>["message"], response: ServiceResult<TaxMerchantExtendDTO>, xhr: any) => void, options?: any): Promise<ServiceResult<TaxMerchantExtendDTO>["data"]> {
    return ajax({
        url: `/remit/merchantextend/queryByMerchantNo`,
        data: {
